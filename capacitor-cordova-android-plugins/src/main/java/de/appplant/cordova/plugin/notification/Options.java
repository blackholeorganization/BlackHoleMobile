...
public final class Options {
    ...
    public String getSubtitle() {
        Object text = options.opt("subtitle");
        return text instanceof String ? (String) text : "";
    }
    //TODO new Option
    /**
    ...
    /**
     * get file path for the local notification.
     */
    Uri getFilePath() {
        return assets.parse(options.optString("filePath", null));
    }
