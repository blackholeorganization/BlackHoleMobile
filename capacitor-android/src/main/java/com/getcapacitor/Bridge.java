...
//  public static final String DEFAULT_WEB_ASSET_DIR = "public";
  public String webAssetsDirectory = "public";
  ...
  public Bridge(Activity context, WebView webView, List<Class<? extends Plugin>> initialPlugins, CordovaInterfaceImpl cordovaInterface, PluginManager pluginManager, CordovaPreferences preferences, JSONObject config,String webAssetsDirectory) {
    this.webAssetsDirectory = webAssetsDirectory;
  ...
  private void loadWebView() {
    ...
    localServer.hostAssets(webAssetsDirectory);
