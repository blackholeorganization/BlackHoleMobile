...
//    }
     ...
     */
    protected void launchApp(String launchActivityName) {
//        Context context = getApplicationContext();
...
//            return;
        try {
            Class<?> c = Class.forName(launchActivityName);
            Intent intent = new Intent(context,c);
            intent.addFlags(
                    FLAG_ACTIVITY_REORDER_TO_FRONT | FLAG_ACTIVITY_SINGLE_TOP | Intent.FLAG_ACTIVITY_NEW_TASK);
