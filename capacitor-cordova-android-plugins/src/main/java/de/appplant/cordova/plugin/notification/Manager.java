...
public final class Manager {
     ...
     */
    public Notification schedule (int hashCode, Request request, Class<?> receiver,String launchActivityName) {
        Options options    = request.getOptions();
        Notification toast = new Notification(context, options);

        toast.schedule(hashCode,request, receiver, launchActivityName);
     ...
     * @param receiver Receiver to handle the trigger event.
     */
    public Notification update (int hashCode,int id, JSONObject updates, Class<?> receiver,String launchActivityName) {
        Notification notification = get(id);

        if (notification == null)
            return null;

        notification.update(hashCode,updates, receiver,launchActivityName);
